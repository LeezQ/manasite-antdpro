            ...
            <span style={{marginBottom: 24}}>
              <Button type="primary" htmlType="submit">
               ...
               <Button style={{marginLeft: 8}} type="primary" onClick={this.handleAddAllChannel}>
                ...
                <Button style={{float:'right' }} type="primary" onClick={this.handleAddChannel}>增加兴趣
  </Button>
            </span>
          </Col>
        </Row>
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: val => (
          <Fragment>
            <div style={{paddingLeft: val.pid == "0" ? '0px' : '30px'}}>{val.name == ""?val.displayName:val.name}</div>
          </Fragment>
        ),
      },
      {
      ...
      },
      {
        ...
        render: val => (
          <Fragment>
            {val.pid == 0 ? <a onClick={() => this.handleAddChildChannel(val)}>添加子频道</a>
